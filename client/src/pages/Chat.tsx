...
const Chat: React.FC = () => {
    ...
    const [socketReadyStatus, SetReadyStatus] = React.useState<'pending'|'ready'>('pending');
    const PopupVisible = useTypedSelector(state => state.componentsReducer.popupVisible);
    const MenuVisible = useTypedSelector(state => state.componentsReducer.menuVisible);
    ...
    <div className="wrapper">
        ...
        <div className="sideWrapper">
            ...
            <div className="sideWrapperMenu">
                <MenuOutlined className="menuButton" onClick={()=>dispatch({type:"MENU:SET_VISIBLE"})}/>
                <input type="text" name="search" id="searchChannel" autoCapitalize="off" autoComplete="off" spellCheck="false"  onChange={onChangeSearchInput} value={searchValue}  placeholder="Search" />
            </div>
        ...
        {currentChannel[0] && socketReadyStatus === 'ready' && <div className="chatBody">
