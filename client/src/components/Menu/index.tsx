...
import {SettingOutlined, UserAddOutlined, BulbOutlined } from "@ant-design/icons"; 
...
const Menu: React.FC = () => {
    ...
    const onChangeUsernameInput = (event: { target: { value: React.SetStateAction<string>; }; }) => {
    ...
    return(
        <div className={styles.overlay}>
            <div className={styles.menu} id={fadeOut? styles.slideOut : ''} ref={menuRef}>
                <div className={styles.userInfo}>
                    <div className={styles.userPic}>
                        <img src={defaultPhoto} alt="defaultPhoto" />
                    </div>
                    <input className={styles.userNameField} placeholder="Username" value={usernameValue} onChange={onChangeUsernameInput}/>
                </div>
                ...
                <span>prod by </span><a href="https://github.com/ClockworkSilvio/">ClockworkSilvio</a><span>, 2021</span>
                </div>
            </div>
        </div>
    );
